...
def main():
    ...
    while running:
        ...
        if not gameOver and not isHumanTurn:
            AImove = RandomAI.findRandomMove(gs.getValidMoves())
            gs.makeMove(AImove)
            moveMade = True
            animate = True
...
def highlightSquares(screen, gs, vaildMoves, squaresSelected):
    if squaresSelected != ():
...
def drawGameState(screen, gs, vaildMoves, squaresSelected):
    drawBoard(screen)
    highlightSquares(screen, gs, vaildMoves, squaresSelected)
